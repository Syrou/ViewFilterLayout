...
public class MagicLayout extends RelativeLayout {
    ...
    private static final String TAG = MagicLayout.class.getSimpleName();
    ...
    public RelativeLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MagicLayout.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof MagicLayout.LayoutParams;
    }
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        TypedArray arr = context.obtainStyledAttributes(attributeSet, R.styleable.MagicLayout);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < numOfChildren; i++) {
            ...
            if (child.getLayoutParams() instanceof MagicLayout.LayoutParams) {
                MagicLayout.LayoutParams layoutParams = (LayoutParams) child.getLayoutParams();
    ...
    public class LayoutParams extends RelativeLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray arr = context.obtainStyledAttributes(attrs, R.styleable.MagicLayout_LayoutParams);
            hidePriority = arr.getInteger(R.styleable.MagicLayout_LayoutParams_hidePriority, -1);
            arr.recycle();
        }
